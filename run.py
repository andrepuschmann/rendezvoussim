...
for i in range(1,21):
    subprocess.call(["./rendezvoussim2.py", "-c 32", "-a random", "-i 10000", "-m", "async", "-q", "-n 2", "-g %d" % i])
    #subprocess.call(["./rendezvoussim2.py", "-c 32", "-a jumpstay", "-i 1000", "-m", "async", "-q", "-n 2", "-g %d" % i])
